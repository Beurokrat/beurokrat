    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="w-full flex flex-row justify-between">
                <p className="w-[60%]">By sending this form I confirm that I have read and accept the Privacy Policy</p>
                <Button text="Send Message" onClick={() => console.log('contact message sent')} />
            </div>
        </div>
    )
}
